        ...
        <div className="mt-14 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
          {industries.map(({ icon: Icon, title }, index) => (
            <Reveal key={title} delay={(index % 6) * 0.05}>
              <div className="group flex h-full flex-col items-center gap-4 rounded-xl border border-slate-200 bg-white px-4 py-8 text-center shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-all duration-300 hover:-translate-y-1 hover:border-primary-200 hover:shadow-[0_16px_36px_-16px_rgba(15,23,42,0.2)]">
