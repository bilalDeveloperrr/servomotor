    ...
    <>
      ...
      <section className="relative overflow-hidden bg-navy-950 py-28 sm:py-36">
        ...
        <Container className="relative">
          ...
          >
            <span className="flex h-16 w-16 items-center justify-center rounded-xl border border-primary-400/25 bg-primary-500/10">
              <SearchX className="h-8 w-8 text-primary-300" strokeWidth={1.75} />
            </span>

            <p className="mt-8 font-display text-7xl font-bold text-white sm:text-8xl">404</p>
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
              ...
              <Button as={Link} to="/services" variant="outlineLight" size="lg" icon={false}>
